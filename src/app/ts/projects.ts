...
export const myProjects: Project[] = [
  // --- Web Projects ---
  {
    ...
    description:
      "A full-stack, multilingual web application to provide students with AI-generated career roadmaps, exam preparation tools, and scholarship information.",
    tech: [
      "React",
      "Python",
      "Tailwind",
...
},
{
  ...
  gallery: [
    "./projects/web/devwebstudio/banner.jpg",
    "./projects/web/devwebstudio/1.jpg",
    "./projects/web/devwebstudio/2.jpg",
  ],
  ...
  // --- 3D Projects ---
  {
    ...
    gallery: ["./projects/3d/donut/1.png"],
  ...
  },
  {
    ...
    gallery: ["./projects/3d/dice/1.mp4", "./projects/3d/dice/2.png"],
  ...
  },
  {
    ...
    gallery: ["./projects/3d/numbers/1.mp4", "./projects/3d/numbers/2.mp4"],
  ...
  },
  {
    ...
    gallery: ["./projects/3d/water/1.mp4"],
...
Through experimentation with different animation techniques and shader effects, the scene aims to evoke a sense of excitement and intrigue while highlighting the potential of 3D animation for product visualization.
  ...
  },
  {
    ...
    gallery: ["./projects/3d/lamp/1.mp4"],
...
Through careful tuning of shader settings and compositing techniques, the project aims to showcase the transformative power of lighting in 3D visualization while honing fundamental modeling and rendering skills.
  ...
  
  {
    ...
    gallery: ["./projects/graphics/animation/1.mp4"],
...
The full magazine is attached below for reference, highlighting the versatility and potential of PowerPoint as a design platform.
  ...
  },
  {
    ...
    gallery: ["./projects/graphics/Books/book/1.jpg"],
